...
/// Caller-supplied oracle type: answers whether (integration, method)
/// names a registered key/OAuth method.
pub type KnownMethods = dyn Fn(&str, &str) -> Option<MethodKind>;
