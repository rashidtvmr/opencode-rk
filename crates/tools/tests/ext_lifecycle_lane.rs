...
//! owns exactly `src/ext_lifecycle_lane.rs` + this file; the integrator wires
//! `pub mod ext_lifecycle_lane;` into `lib.rs` later.

#[path = "../src/ext_lifecycle_lane.rs"]
mod ext_lifecycle_lane;
