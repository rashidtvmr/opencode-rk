...
//! owns exactly `src/ext_namespacing_lane.rs` + this file; no `lib.rs` edit.

#[path = "../src/ext_namespacing_lane.rs"]
mod ext_namespacing_lane;

use ext_namespacing_lane::{EntryKind, MAX_NAMES, NameDecl, Namespace, NamespaceError};
