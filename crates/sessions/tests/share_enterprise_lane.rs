//! Frozen RED suite for SHARE-003 enterprise-remote boundary (lane).
//!
//! Task: tasks/SHARE-003.md T01..T05. `#[path]` include: the lane module
//! `share_enterprise_lane.rs` is owned by this lane and is NOT wired into
