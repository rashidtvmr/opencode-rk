...
//!
//! `#[path]` include: `share_store_lane.rs` is owned by this lane and is NOT
//! wired into `lib.rs` (integrator assembles shared files).

#[path = "../src/share_store_lane.rs"]
mod share_store_lane;

use opencode_rk_contracts::SessionId;
use share_store_lane::{ShareId, ShareSecret, ShareStore, StoreError, MAX_SHARES};
